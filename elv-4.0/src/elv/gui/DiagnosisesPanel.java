...
public class DiagnosisesPanel extends javax.swing.JPanel implements elv.util.Saveable
{
  ...
  public DiagnosisesPanel(elv.task.Task task, elv.util.parameters.Diagnosis parameterType, elv.task.Task cloneableTask)
  {
    ...
    try
    {
      ...
      initComponents();
      elv.util.ViewTooltips.register(diagnosisesTree);
  ...
  {//GEN-HEADEREND:event_addButtonActionPerformed
    try
    {
      ...
      elv.util.ViewTooltips.register(allDiagnosisesTree);
  ...
  public void save()
  {
    if(isChanged())
    {
      try
      {
        elv.util.client.ClientStub.storeParameters(task.getPropertyFolderPath() + "/" + parameterType.getFile(), diagnosises);
        if(task != null)
        {
