  ...
  private class PropertiesTableCellEditor extends javax.swing.DefaultCellEditor
  {
    ...
    private void getListValues()
    {
      try
      {
        ...
        elv.util.ViewTooltips.register(editorList);
    ...
    private void getTaskTreeValue()
    {
      try
      {
        ...
        elv.util.ViewTooltips.register(editorTree);
        ...
        editorTree.setModel(new javax.swing.tree.DefaultTreeModel(new elv.util.Node(root)));
  ...
  public void save()
  {
    if(isChanged())
    {
      try
      {
        ...
        java.lang.String pathName = folderPath + "/" + propertable.getPropertyFile();
