...
/**
 * Class for editing attributes of task executables.
 * @author Elv
 */
public class AttributesPanel extends PropertiesPanel
{
   ...
   */
  public AttributesPanel(elv.task.executables.Executable executable, elv.task.Task task, elv.task.Task cloneableTask)
  {
    super(executable);
