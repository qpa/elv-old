...
public class PdfPanel extends javax.swing.JPanel
{
  ...
  {
    elv.util.ViewTooltips.register(bookmarkTree);
      ...
      public java.lang.Object construct()
      {
        try
        {
          ...
          for(int i = 0; i < pdfDecoder.getPageCount(); i++)
          {
            ...
            {
              java.awt.image.BufferedImage thumbnailImage = pdfDecoder.getPageAsImage(i + 1);
              ...
              javax.swing.ImageIcon thumbnailIcon = new javax.swing.ImageIcon(thumbnailImage.getScaledInstance(-1, THUMBNAIL_HEIGHT, java.awt.image.BufferedImage.SCALE_FAST));
