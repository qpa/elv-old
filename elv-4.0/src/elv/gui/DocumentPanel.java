  ...
  public DocumentPanel(elv.task.Task task, java.lang.String fileName)
  {
    ...
    try
    {
      ...
      java.lang.String file = elv.util.server.Servlet.FILE + elv.util.server.Servlet.EQUALS +
        java.net.URLEncoder.encode(task.getExecutionFolderPath() + "/" + fileName, elv.util.server.Servlet.URL_ENCODING);
      ...
      if(task.getContainer() instanceof elv.task.Archive)
      {
        ...
        entry = elv.util.server.Servlet.ENTRY + elv.util.server.Servlet.EQUALS +
          java.net.URLEncoder.encode(task.getName() + "/" + elv.task.Task.EXECUTION_FOLDER + "/" + fileName, elv.util.server.Servlet.URL_ENCODING);
      }
      java.lang.String query = file + elv.util.server.Servlet.AND + type + elv.util.server.Servlet.AND + entry;
      java.net.URL documentURL = new java.net.URL(elv.util.client.ClientStub.getServletURL() + elv.util.server.Servlet.QUERY + query);
      ...
      if(fileExtension.equalsIgnoreCase("csv"))
      {
        ...
        htmlDocumentURL = new java.net.URL(elv.util.client.ClientStub.getServletURL() + elv.util.server.Servlet.QUERY + query);
      }
