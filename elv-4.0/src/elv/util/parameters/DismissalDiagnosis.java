/*
 * DismissalDiagnosis.java
 */
package elv.util.parameters;

/**
 * Class for reprezenting a dismissal parameter.
 * @author Elv
 */
public class DismissalDiagnosis extends Diagnosis
{
  
  /**
   * Constants.
   */
  private final static java.lang.String FILE = "dismissals.param";
  private final static java.lang.String FILE_BASE = "dismissal";
  private final static java.lang.String TITLE = "Diagnosis.Dismissals";
   ...
   */
  public DismissalDiagnosis(java.lang.String line) throws java.lang.Exception
  {
    super(line);
  }
  ...
  {
    return (P)new DismissalDiagnosis(line);
  }
  ...
  {
    return (P)new DismissalDiagnosis(DEFAULT_LINE);
  }
