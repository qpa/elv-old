/*
 * AddmissionDiagnosis.java
 */
package elv.util.parameters;

/**
 * Class for reprezenting an addmission parameter.
 * @author Elv
 */
public class AddmissionDiagnosis extends Diagnosis
{
  
  /**
   * Constants.
   */
  private final static java.lang.String FILE = "addmissions.param";
  private final static java.lang.String FILE_BASE = "addmission";
  public final static java.lang.String TITLE = "Diagnosis.AddmissionTypes";
   ...
   */
  public AddmissionDiagnosis(java.lang.String line) throws java.lang.Exception
  {
    super(line);
  }
  ...
  {
    return (P)new AddmissionDiagnosis(line);
  }
  ...
  {
    return (P)new AddmissionDiagnosis(DEFAULT_LINE);
  }
