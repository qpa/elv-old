 ...
 * @author Elv
 */
public class InsertMorbidity
{
  
  /**
   * Constructor.
   */
  public InsertMorbidity()
  {
  }
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      java.lang.String tableName = "morbidity";
...
//      dbConnection = java.sql.DriverManager.getConnection("jdbc:h2:/home/elv/data/db/elv;LOG=0;CACHE_SIZE=4096", "elv", "elv");
...
//      csvProperties.put("charset","ISO-8859-2");       // file encoding is "ISO-8859-2"
      ...
      for(int year = 1997; year <= 2002; year++)
      {
        java.lang.String fileBaseName = "morbidity_" + year;
        ...
        {
          count++;
          java.lang.String insertString = "INSERT INTO " + tableName + " VALUES(" + rs.getObject(1);
          for(int i = 1; i < meta.getColumnCount(); i++)
          {
            java.lang.Object columnObject = rs.getObject(i + 1);
            insertString += ", " + (columnObject instanceof java.lang.String ? "'" + columnObject + "'" : columnObject);
          }
          insertString += ")";
