...
public class Property<V> implements java.io.Serializable, java.lang.Cloneable
{
  ...
  public Property(java.lang.String line) throws java.lang.Exception
  {
    ...
    java.lang.String[] splits = tehn.split(java.util.regex.Pattern.quote("|"));
    type = splits[0];
    editorType = splits[1];
    haveToTranslate = java.lang.Boolean.parseBoolean(splits[2]);
    name = splits[3];
    parse(v);
  }
...
//    this.type = value.getClass().getName();
  ...
  private java.lang.String formatString() throws java.lang.Exception
  {
    ...
    {
      char echoChar = new javax.swing.JPasswordField().getEchoChar();
      java.lang.String passwordValue = java.lang.String.valueOf(new char[]{echoChar, echoChar, echoChar, echoChar, echoChar, echoChar});
