...
public class Util
{
  ...
  /** 
   * Method for setting the user properties (the static the variables).
   ...
   */
  public static void setUserProperties(elv.gui.Manager aMainFrame, User aUser) throws java.lang.Exception
  {
  ...
  public static java.awt.Point parsePoint(java.lang.String string) throws java.lang.Exception
  {
    int x = 0;
    int y = 0;
    java.lang.String[] splits = string.split(java.util.regex.Pattern.quote(","));
    x = java.lang.Integer.parseInt(splits[0].trim());
    y = java.lang.Integer.parseInt(splits[1].trim());
  ...
  public static synchronized void copy(java.lang.String fromPath, java.lang.String toPath) throws java.lang.Exception
  {
    ...
    if(fromFile.isDirectory())
    {
      ...
      {
        copy(fromPath + "/" + paths[i], toPath + "/" + paths[i]);
      }
    }
    else
    {
