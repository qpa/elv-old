...
public class User<P> extends elv.util.Propertable implements java.io.Serializable, elv.util.Visualizable, elv.util.Parentable
{
   ...
   * @param root the root of the user.
   * @param name the name of a user.
   * @throws java.lang.Exception if there is any creation error.
   */
  public User(elv.util.Root root, java.lang.String name, int type) throws java.lang.Exception
  {
   ...
   */
  public static User parse(elv.util.Root root, java.lang.String name) throws java.lang.Exception
  {
    User user = new User(root, name, 0);
  ...
  /**
   * Method for getting the root of the user.
   * @return the root object of this user.
   */
  public elv.util.Root getRoot()
  {
    return root;
  }
  ...
  {
    return root.getFolderPath() + "/" + name;
  }
  ...
  public synchronized void move(User newUser) throws java.lang.Exception
  {
    ...
    if(!done)
    {
      throw new java.io.IOException("Cannot rename " + getFolderPath() + " to " + newUser.getFolderPath());
    }
  ...
  {
    java.lang.String newName = Util.getNumbered(newUser.getName(), Util.vectorize(new java.io.File(root.getFolderPath()).list()), null);
    java.lang.String newFolderPath = root.getFolderPath() +"/" + newName;
  ...
  public java.lang.Object clone()
  {
    ...
    try
    {
      cloneUser = new User(root, name, type);
  ...
  {
    return new java.io.File(getFolderPath()).exists();
  }
  ...
  public synchronized void loadChildren() throws java.lang.Exception
  {
    ...
    for(int i = 0; i < files.length; i++)
    {
      ...
      java.io.File file = new java.io.File(getFolderPath() + "/" + files[i]);
