...
public class Servlet extends javax.servlet.http.HttpServlet
{
  ...
  // Variable.
  /** The stub of this servlet session */
  private ServerStub serverStub = null;
  ...
  public void destroy()
  {
    try
    {
      if(serverStub.getDataBaseConnection()!= null)
      {
        ...
        java.lang.System.out.println("ELV: " + dateFormat.format(new java.util.Date()) + " Disconnecting from database");
        serverStub.getDataBaseConnection().close();
        java.lang.System.out.println("ELV: " + dateFormat.format(new java.util.Date()) + " Disconnected from database");
      }
    }
