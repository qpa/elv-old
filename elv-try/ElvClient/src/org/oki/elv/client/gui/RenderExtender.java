...
License at http://www.netbeans.org/cddl.html or
http://www.netbeans.org/cddl.txt. When distributing Covered Code,
include this CDDL Header Notice in each file and include the License
file at http://www.netbeans.org/cddl.txt. If applicable, add the
...
[year] [name of copyright owner]" Copyright 2006 Sun Microsystems, all
rights reserved. */
 ...
 * @author Elv
 */
public final class RenderExtender extends MouseAdapter implements MouseMotionListener {
    /** The default instance, reference counted */
    private static RenderExtender INSTANCE = null;
...
//        }
    ...
    private static final class ImgComp extends JComponent {
      /** Serial ID. */
      private static final long serialVersionUID = -1650844504553649847L;
...
//            at = AffineTransform.getTranslateInstance(-off.x, 0);
            at = AffineTransform.getTranslateInstance(-off.x, -1); // Modified by Elv.
    ...
    private static final class Hider implements ChangeListener, PropertyChangeListener, TreeModelListener, TreeSelectionListener, HierarchyListener, HierarchyBoundsListener, ListSelectionListener, ListDataListener, ComponentListener {
        ...
        private void change() {
            if (RenderExtender.INSTANCE != null) {
                RenderExtender.INSTANCE.hide();
            }
            detach();
        }
