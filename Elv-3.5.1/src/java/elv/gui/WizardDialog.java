  ...
  private void userNextAction()
  {
    try
    {
      ...
      else if(stageCount == 2)
      {
        ...
        java.lang.String pathName = newUser.getFolderPath() + elv.util.Util.getFS() + newUser.getPropertyFile();
  ...
  private void taskNextAction()
  {
    try
    {
      ...
      else if(stageCount == initializeCount + parameterCount + executableCount)
      {
        ...
        {
          java.lang.String pathName = newTask.getPropertyFolderPath() + elv.util.Util.getFS() + iteratorExecutable.getPropertyFile();
