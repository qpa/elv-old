...
public class ImagePanel extends javax.swing.JPanel
{
  ...
  {//GEN-HEADEREND:event_zoomComboBoxActionPerformed
    try
    {
      ...
      if(zoomValue <= 1)
      {
        imageLabel.setIcon(new javax.swing.ImageIcon(image.getScaledInstance(newWidth, newHeight, java.awt.Image.SCALE_SMOOTH)));
      }
      else
      {
        imageLabel.setIcon(new javax.swing.ImageIcon(image.getScaledInstance(newWidth, newHeight, java.awt.Image.SCALE_FAST)));
      }
