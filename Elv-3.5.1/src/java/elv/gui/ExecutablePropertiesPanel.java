  ...
  public ExecutablePropertiesPanel(elv.task.executables.Executable executable, elv.task.Task task, elv.task.Task cloneableTask)
  {
    ...
    try
    {
      ...
      if(state.equals(new elv.util.State(elv.util.State.UNDEFINED)))
      {
        if(cloneableTask != null)
        {
          ...
          if(!cloneState.equals(new elv.util.State(elv.util.State.UNDEFINED)))
          {
            ...
            {
              java.lang.String name = cloneableTask.getName() + elv.util.Util.ZIP_SEPARATOR + cloneableTask.PROPERTY_FOLDER + elv.util.Util.ZIP_SEPARATOR + executable.getPropertyFile();
      ...
      else
      {
        ...
        {
          java.lang.String name = task.getName() + elv.util.Util.ZIP_SEPARATOR + task.PROPERTY_FOLDER + elv.util.Util.ZIP_SEPARATOR + executable.getPropertyFile();
      ...
      if(executable instanceof elv.task.executables.Standardization && !(executable instanceof elv.task.executables.SpotStandardization))
      {
        ...
        try
        {
          ...
          if(task.getContainer() instanceof elv.task.Archive)
          {
            java.lang.String name = task.getName() + elv.util.Util.ZIP_SEPARATOR + task.PROPERTY_FOLDER + elv.util.Util.ZIP_SEPARATOR + yeatIntervalType.getFile();
  ...
  public void save()
  {
    if(isChanged())
    {
      try
      {
        if(task != null)
        {
          java.lang.String pathName = task.getPropertyFolderPath() + elv.util.Util.getFS() + executable.getPropertyFile();
          ...
          pathName = task.getPropertyFolderPath() + elv.util.Util.getFS() + task.getPropertyFile();
