  ...
  private class WizardTreeModel extends javax.swing.tree.DefaultTreeModel
  {
    ...
    public WizardTreeModel()
    {
      ...
      try
      {
        ...
        {
          // New.
          elv.util.Node newNode = new elv.util.Node(new elv.util.User(elv.util.Util.translate(new elv.util.Action(elv.util.Action.NEW).getName()), elv.util.User.SINGLE));
