...
public class Archive<P> extends Container
{
  ...
  private synchronized void add(java.lang.String path, java.lang.String parentEntryName, java.util.zip.ZipOutputStream zipStream, java.util.Vector<java.lang.String> entryNames) throws java.lang.Exception
  {
    ...
    if(file.isFile())
    {
      java.lang.String entryName = elv.util.Util.getNumbered(parentEntryName + file.getName(), entryNames, elv.util.Util.ZIP_SEPARATOR);
    ...
    {
      java.lang.String entryName = elv.util.Util.getNumbered(parentEntryName + file.getName() + elv.util.Util.ZIP_SEPARATOR, entryNames, elv.util.Util.ZIP_SEPARATOR);
      entryNames.add(entryName);
      java.util.zip.ZipEntry zipEntry = new java.util.zip.ZipEntry(entryName);
      zipStream.putNextEntry(zipEntry);
      ...
      {
        add(path + elv.util.Util.getFS() + iteratorFile , zipEntry.getName(), zipStream, entryNames);
      }
    }
  }
  ...
  public synchronized void get(java.lang.String entry, java.lang.String folderPath) throws java.lang.Exception
  {
    ...
    for(java.util.Enumeration entries = archiveZipFile.entries(); entries.hasMoreElements(); )
    {
      ...
      if(iteratorEntry.getName().matches(".*" + NOT_WORD_CHARACTER + java.util.regex.Pattern.quote(entry) + NOT_WORD_CHARACTER + ".*"))
      {
        ...
        java.util.StringTokenizer sT = new java.util.StringTokenizer(iteratorEntry.getName(), elv.util.Util.ZIP_SEPARATOR);
        ...
        while(sT.hasMoreTokens())
        {
          ...
          {
            pathName += elv.util.Util.getFS() + token;
          }
        }
        pathName = folderPath + elv.util.Util.getFS() + pathName;
  ...
  public synchronized void get(java.lang.String entry, Archive targetArchive) throws java.lang.Exception
  {
    ...
    for(java.util.Enumeration entries = archiveZipFile.entries(); entries.hasMoreElements(); )
    {
      ...
      if(iteratorEntry.getName().matches(".*" + NOT_WORD_CHARACTER + java.util.regex.Pattern.quote(entry) + NOT_WORD_CHARACTER + ".*"))
      {
        ...
        java.lang.String entryName = elv.util.Util.getNumbered(iteratorEntry.getName().substring(iteratorEntry.getName().indexOf(entry)), entryNames, elv.util.Util.ZIP_SEPARATOR);
        entryNames.add(entryName);
  ...
  public void loadChildren() throws java.lang.Exception
  {
    ...
    for(java.util.Enumeration entries = archiveZipFile.entries(); entries.hasMoreElements(); )
    {
      ...
      if(iteratorEntry.isDirectory())
      {
        ...
        if(sT.countTokens() == 1)
        {
          Task child = Task.parse(this, sT.nextToken());
