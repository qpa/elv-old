...
public class ServerStub
{
  ...
  {
    return elv.util.Root.loadAllDescendants();
  }
  ...
  {
    return Servlet.getExecutor().getExecutedTasks();
  }
  ...
  public synchronized static java.util.Vector getExecutionProgresses(elv.task.Task task) throws java.lang.Exception
  {
    ...
    elv.task.Execution execution = Servlet.getExecutor().get(task);
    if(execution != null)
    {
  ...
  public synchronized static java.util.Vector<java.lang.String> getEnvironmentVariables() throws java.lang.Exception
  {
    ...
    environmentVariables.add(java.lang.String.valueOf(elv.util.Util.getConcurrentCount()));
    environmentVariables.add(elv.util.Util.getFS());
    environmentVariables.add(elv.util.Util.getWorkFolder());
    environmentVariables.add(elv.util.Util.getLogFolder());
    environmentVariables.add(elv.util.Util.getDatabaseURL());
  ...
  public synchronized static java.util.Hashtable getEnvironment() throws java.lang.Exception
  {
    ...
    return ((javax.naming.Context)initContext.lookup("java:/comp/env")).getEnvironment();
  }
