...
public class District extends Parameter implements java.lang.Cloneable
{
   ...
   */
  public District(java.lang.String line) throws java.lang.Exception
  {
  ...
  public <P extends Parameter> P parse(java.lang.String line) throws java.lang.Exception
  {
    //Line:  code|name|area|xCoordinate|yCoordinate|aggregation
    java.util.StringTokenizer sT = new java.util.StringTokenizer(line, "|");
    int code = java.lang.Integer.parseInt(sT.nextToken());
    java.lang.String name = sT.nextToken();
    double area = java.lang.Double.parseDouble(sT.nextToken());
    double xCoordinate = java.lang.Double.parseDouble(sT.nextToken());
    double yCoordinate = java.lang.Double.parseDouble(sT.nextToken());
    elv.util.parameters.Aggregation aggregation = new elv.util.parameters.Aggregation(sT.nextToken());
